...
<div id="LogoContent"><stripes:link
	beanclass="com.bestsales.sales.web.actions.CatalogActionBean">
...
<div id="MenuContent"><stripes:link
	beanclass="com.bestsales.sales.web.actions.CartActionBean"
	event="viewCart">
	<img align="middle" name="img_cart" src="../images/cart.gif" />
</stripes:link> <img align="middle" src="../images/separator.gif" /> <c:if
	test="${sessionScope.accountBean == null}">
	<stripes:link
		beanclass="com.bestsales.sales.web.actions.AccountActionBean"
		event="signonForm">
          Sign In
	    </stripes:link>
